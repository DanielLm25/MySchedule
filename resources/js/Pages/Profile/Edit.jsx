        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                        <label className="block font-medium text-gray-700">Tipo de Proteção da Agenda</label>
                        <select
                        ...
                        {permissionType === 'protected' && (
                            <div className="mt-4">
                                <label className="block font-medium text-gray-700">Código de Acesso</label>
                                <input
                                    type="text"
                                    value={accessCode}
                                    readOnly
