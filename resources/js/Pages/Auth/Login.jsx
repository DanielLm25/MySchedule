                ...
                <div className="flex items-center justify-center min-h-screen">
                    <div className="max-w-lg w-full bg-gray-100 p-8 rounded-lg shadow-xl">
                        ...
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <PrimaryButton
                                type="submit"
                                className="w-48 ml-[125px] bg-blue-600 hover:bg-gradient-to-r hover:from-blue-800 hover:to-blue-800 text-white py-4 rounded-full shadow-lg text-xl flex items-center justify-center transition-all duration-300 ease-in-out transform hover:scale-105"
                                disabled={processing}
